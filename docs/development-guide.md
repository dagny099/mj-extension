...
This guide is to give developers the information needed to set up, modify, test, and contribute to the Midjourney Image Tracker Chrome extension.
...
```bash
git clone https://github.com/dagny099/midjourney-toolkit.git
cd midjourney-toolkit
```
